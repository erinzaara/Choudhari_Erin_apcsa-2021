...
public class OddToEvenRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println( ListOddToEven.go( Arrays.asList(32767,70,4,5,6,7) ) );
		System.out.println( ListOddToEven.go( Arrays.asList(2,7,11,21,5,7) ) );
		System.out.println( ListOddToEven.go( Arrays.asList(7,255,11,255,100,3,2) ) );
		System.out.println( ListOddToEven.go( Arrays.asList(9,11,11,11,7,1000,3) ) );
		System.out.println( ListOddToEven.go( Arrays.asList(7,7,7,11,2,7,7,11,11,2) ) );
