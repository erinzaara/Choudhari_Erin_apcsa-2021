...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Mr.Mauro",0) >= 0)
		{
		...
		else if (findKeyword(statement, "sports",0) >= 0)
		{
			response = "Playing sports is healthy for you. Tell me about your favorite sport.";
		}
		else if (findKeyword(statement, "music",0) >= 0)
		{
			response = "Tell me more about the music you like.";
		}
